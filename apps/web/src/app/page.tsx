  ...
  return (
    <main>
      ...
      <section className="mx-auto grid max-w-6xl gap-12 px-6 pb-24 pt-20 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
        <div>
          <p className="mb-4 text-sm font-bold uppercase tracking-[0.18em] text-[var(--action-primary)]">
            Pet care, connected
          </p>
        ...
        <aside className="rounded-3xl border border-[var(--border-default)] bg-[var(--surface-default)] p-6 shadow-[0_24px_70px_rgba(30,55,42,0.10)]">
