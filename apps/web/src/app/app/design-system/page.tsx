  ...
  return (
    <div>
      ...
      <p className="mt-2 max-w-3xl leading-7 text-[var(--text-secondary)]">
        A review surface for shared components, semantics, interaction states, and accessible tenant-safe
        styling. Examples use visible labels and do not rely on color alone.
      </p>

      <div className="mt-8 grid gap-6">
        <Card title="Actions" description="Minimum 44px targets with visible keyboard focus and explicit states.">
        ...
        <Card title="Statuses" description="Every status has a textual label in addition to its color treatment.">
          <div className="flex flex-wrap gap-3">
            <Badge>Draft</Badge>
        ...
        <Card title="Messages and exceptions">
          <div className="grid gap-3">
            ...
            <Alert title="Ready" tone="success">All required information is present.</Alert>
            <Alert title="Review required" tone="warning">One vaccination expires before the stay.</Alert>
            <Alert title="Unable to continue" tone="danger">Correct the highlighted information and try again.</Alert>
          </div>
        </Card>
